                    ...
                    <div className="flex flex-col gap-2 text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                          {/* 1. The Raw Code (e.g., 00 20 * * *) */}
                          <span className="font-mono text-[10px] text-slate-500 bg-slate-50 px-1.5 py-0.5 rounded border border-slate-100 w-fit">
                            {generateCron(task)}
                          </span>

                          {/* 2. The Human Readable Text (e.g., Daily at 8:00 PM) */}
                          <span className="text-[10px] text-indigo-600 font-medium mt-0.5">
                            {getCronDescription(generateCron(task))}
                          </span>
                        </div>
                      </div>
                    </div>
